...
function CallQFnc() {
  const match = useMatch("/callqFnc/:id");
  ...
  return (
    <div>
      <Header />
      <div className="App">
        <h1 style={{ paddingTop: 20 }}>เวชระเบียน ช่องบริการที่ {match.params && match.params.id}</h1>
        <hr />
