...
function Dashboard() {
  ...
  function callQFnc(params = 0, call = 0) {
    if (params) {
      setModalShow(true);
      setShowQ(params);
      ...
      if (soundConfig.actived == 1) {
        ...
        const audio1 = new Audio(
          require(`../audio/${params.queue_no.charAt(0)}.mp3`)
        );
        const audio2 = new Audio(
          require(`../audio/${params.queue_no.charAt(1)}.mp3`)
        );
        const audio3 = new Audio(
          require(`../audio/${params.queue_no.charAt(2)}.mp3`)
        );
        const audio4 = new Audio(
          require(`../audio/${params.queue_no.charAt(3)}.mp3`)
        );
        const audio5 = new Audio(require(`../audio/${text4}.mp3`));
        const service = new Audio(require(`../audio/service.mp3`));
        const audioEnd = new Audio(require(`../audio/endcall.mp3`));
        // startAudio(text1, text2, text3, text4, params.queue_type);
        audio.playbackRate = 1.4;
        audio1.playbackRate = 1.4;
        audio2.playbackRate = 1.4;
        audio3.playbackRate = 1.4;
        audio4.playbackRate = 1.4;
        audio5.playbackRate = 1.4;
        service.playbackRate = 1.4;
        audioEnd.playbackRate = 1.4;
        audio.play();
